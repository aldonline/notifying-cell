...
describe 'a cell', ->
  ...
  it 'should be a function with an argument list of length 1', ->
    c1.should.have.length 1

  it 'should return a view-only version with an argument list of length 0', ->
    # this is how we distinguish between R/RW functions
    # ( By inspecting function.length )
    c1.immutable.length.should.equal 0 
